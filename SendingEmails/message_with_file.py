...
from local_settings import EMAIL_TO, EMAIL_FROM, PASSWORD


def send_email(addr_to, msg_subj, msg_text, files):
    addr_from = EMAIL_FROM  # Отправитель
    ...
    # server.set_debuglevel(True)      # Включаем режим отладки, не нужен - комментим
...
addr_to = EMAIL_TO  # Получатель
files = [r"text_of_message.txt"]  # Список файлов, если вложений нет, то files=[]
# Если нужно отправить все файлы из заданной папки, нужно указать её

send_email(addr_to, "Тестируем почту", "text", files)
